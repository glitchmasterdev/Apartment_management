...
def get_dashboard_kpis(building_id: str = None):
...
def get_yoy_occupancy(building_id: str = None):
    """12-Month Year Over Year Occupancy Trend Data for Chart.js"""
...
def get_arrears_aging(building_id: str = None):
    """Arrears aging analysis buckets: 0-30, 31-60, 61-90, 90+ days"""
    return {
        "buckets": {
            "0_30_days": 125000,
            "31_60_days": 48000,
